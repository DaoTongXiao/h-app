  ...
  <view class="page-container">
    ...
    <view class="stepper">
      ...
      <view :class="['step', { active: currentStep === 2 }]">
        ...
        <text class="step-title">材料上传</text>
      </view>
    </view>
    ...
    <view v-if="currentStep === 1" class="form-wrapper">
      <view class="form-card">
        ...
        <view class="form-item">
          ...
          <input class="item-input" v-model="formData.name" placeholder="请输入姓名" placeholder-class="placeholder" />
        </view>
        <view class="form-item">
          <text class="item-label required">身份证号</text>
          <input class="item-input" v-model="formData.idCard" placeholder="请输入身份证号" placeholder-class="placeholder" />
        </view>
        <view class="form-item">
          <text class="item-label required">民族</text>
          <picker @change="bindPickerChange" :value="nationIndex" :range="nationArray">
             <view class="picker-input">{{nationArray[nationIndex]}} <text class="arrow-icon"></text></view>
          </picker>
        </view>
        <view class="form-item">
          <text class="item-label required">联系电话</text>
          <input class="item-input" v-model="formData.phone" type="number" placeholder="请输入联系电话" placeholder-class="placeholder" />
        </view>
        <view class="form-item-column">
          <text class="item-label required">案情及申请理由</text>
          <view class="textarea-wrapper">
            <textarea class="item-textarea" v-model="formData.reason" placeholder="请输入概况信息" placeholder-class="placeholder" maxlength="100" />
            <text class="char-counter">{{ reasonLength }}/100</text>
          </view>
        </view>
      </view>
      <view class="button-wrapper">
        <button class="submit-button" @click="nextStep">下一步</button>
      </view>
    </view>
       ...
       <view class="upload-note">
        ...
        <view class="upload-card">
          <view class="upload-item">
             <text class="item-label required">身份证上传 <text class="support-text">(支持jpg、png、jpeg文件)</text></text>
