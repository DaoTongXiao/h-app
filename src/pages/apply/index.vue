        ...
        >
          <view class="section-block">
            ...
            >
              <view
                ...
                @click="openAddressPicker('applicant')"
              >
                <text :class="{'placeholder': !form.applicant.address}">
                  {{ form.applicant.address || '请选择' }}
                </text>
                <uni-icons
                  type="right"
                  size="16"
          ...
          <view class="section-block">
            ...
            >
              <view class="radio-group-wrapper">
                <uni-data-checkbox
                  v-model="form.respondent.type"
                  :localdata="respondentTypes"
                />
              </view>
            </uni-forms-item>
            <uni-forms-item
            ...
            >
              <view
                class="picker-container"
                @click="openAddressPicker('respondent')"
              >
                <text :class="{'placeholder': !form.respondent.address}">
                  {{ form.respondent.address || '请选择住址' }}
                </text>
                <uni-icons
                  type="right"
                  size="16"
          ...
          <view class="section-block">
            ...
            >
              ...
              >
                <text :class="{'placeholder': !form.caseInfo.date}">
                  {{ form.caseInfo.date || '请选择日期' }}
                </text>
                <uni-icons
                  type="right"
                  size="16"
            ...
            >
              ...
              >
                <text :class="{'placeholder': !form.caseInfo.location}">
                  {{ form.caseInfo.location || '请选择' }}
                </text>
                <uni-icons
                  type="right"
                  size="16"
